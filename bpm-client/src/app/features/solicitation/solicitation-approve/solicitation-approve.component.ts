...
import { Solicitation, SolicitationCommandApprove } from '../shrared/solicitation.model';
import { SolicitationValidator } from '../shrared/solicitation.validator';

@Component({
  selector: 'app-solicitation-approve',
  templateUrl: './solicitation-approve.component.html',
  styleUrls: ['./solicitation-approve.component.sass']
})
